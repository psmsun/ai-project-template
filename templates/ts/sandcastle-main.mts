/**
 * Sandcastle AFK runner — PR-per-issue loop (backlog A2 + A3).
 *
 ...
 * the whole run (a red/blocked PR just stays open; the loop moves on).
 *
...
// Pre-flight: re-check & auto-fix the environment (runtime, pnpm allowBuilds, Dockerfile, image, .env).
